...
beautiful.init("home/frank/.config/awesome/theme-def.lua")
...
-- Autostart
-- ===================================================================
awful.spawn.with_shell("xrandr --output DisplayPort-1 --primary --left-of eDP")
awful.spawn.with_shell("xautolock -time 30 -locker 'systemctl suspend'")
awful.spawn.with_shell("picom --experimental-backends")zrrr
