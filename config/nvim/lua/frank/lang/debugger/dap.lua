...
dap.adapters.cppdbg = {
    id = 'cppdbg',
    type = 'executable',
    command = '/home/frank/.config/nvim/lua/alex/lang/debugger/tools/vscode-cpptools/extension/debugAdapters/bin/OpenDebugAD7',
}

local cache = require 'frank.lang.debugger.cache'
